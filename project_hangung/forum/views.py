...
from .models import Question, Comment, Image
...
def index(request):
    ...
    if gung == 'all':
        if so == 'recommend':
            ...
            question_list = Question.objects.annotate(num_comment=Count('comment')).order_by('-num_comment', '-create_date')
        else:  # recent
        ...
        if so == 'recommend':
            ...
            question_list = Question.objects.filter(gung='경복궁').annotate(num_comment=Count('comment')).order_by('-num_comment', '-create_date')
        else:  # recent
        ...
        if so == 'recommend':
            ...
            question_list = Question.objects.filter(gung='창덕궁').annotate(num_comment=Count('comment')).order_by('-num_comment', '-create_date')
        else:  # recent
        ...
        if so == 'recommend':
            ...
            question_list = Question.objects.filter(gung='창경궁').annotate(num_comment=Count('comment')).order_by('-num_comment', '-create_date')
        else:  # recent
        ...
        if so == 'recommend':
            ...
            question_list = Question.objects.filter(gung='덕수궁').annotate(num_comment=Count('comment')).order_by('-num_comment','-create_date')
        else:  # recent
